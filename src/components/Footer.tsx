...
export default function Footer() {
    return (
        <footer className="w-full bg-[#004956]">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        <Link href="/" className="flex justify-center xl:justify-start lg:justify-start items-center">
                            <Image src="/idea.svg" width={60} height={60} alt="logo" />
                            <h3 className="text-2xl text-[#B4EDE1] font-semibold">I D E A</h3>
                        </Link>
                        <p className="py-8 text-sm text-[#f2f2f2] lg:max-w-xs text-center lg:text-left">Trusted in more than 100 countries & 5 million customers. Have any query ?</p>
                        <Link href="javascript:;" className="py-2.5 px-5 h-9 block w-fit bg-[#BDF3E6] rounded-full shadow-sm text-xs text-black mx-auto transition-all  duration-500 hover:bg-white lg:mx-0">
                            Contact us
                        </Link>
                    </div>
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-[#B4EDE1] font-medium mb-7">Company</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;" className="text-gray-400 hover:text-gray-300">Home</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-300">About</a></li>
                            <li><a href="javascript:;" className=" text-gray-400 hover:text-gray-300">Pricing</a></li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-[#B4EDE1] font-medium mb-7">Products</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;" className="text-gray-400 hover:text-gray-300">Figma UI System</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-300">Icons Assets</a></li>
                            <li><a href="javascript:;" className=" text-gray-400 hover:text-gray-300">Responsive Blocks</a></li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-[#B4EDE1] font-medium mb-7">Support</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;" className="text-gray-400 hover:text-gray-300">Customer Support</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-300">Terms & Conditions</a></li>
                            <li ><a href="javascript:;" className=" text-gray-400 hover:text-gray-300">Privacy Policy</a></li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-[#B4EDE1] font-medium mb-7">Subscribe</h4>
                        <p className="text-sm text-gray-400 leading-6 mb-7">Subscribe to get the latest news from us</p>
                        <a href="javascript:;" className="flex items-center justify-center gap-2 border border-[#BDF3E6] rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-white font-semibold transition-all duration-500 hover:bg-[#BDF3E6] hover:text-black">Subscribe
                        </a>
                    </div>
                </div>
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-[#f2f2f2] ">©<a href="https://pagedone.io/">I D E A</a> 2024, All rights reserved.</span>
