...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{""}
    <FaMinus 
    className="relative top-[1px] ml-1 h-3 w-3 transition duration-400 group-data-[state=open]:rotate-180 group-data-[state=open]:block hidden"   
    aria-hidden="true"
    />
    <FaPlus
      className="relative top-[1px] ml-1 h-3 w-3 transition duration-400 group-data-[state=open]:hidden"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
